...
Observation_SNR=12;
 ...
 for EbN0dB = Eb_No_start:Eb_No_step:Eb_No_end
   ...
   for frame_index = 1: max_num_frame    
       ...
       bit_stream=ones(1,frame_size);
       random_values=randn(1,frame_size);
       temp_index=find(random_values<0);
       bit_stream(temp_index)=0;
       ...
       symbol_stream(temp_index)=-1;
        ...
        %noise addition
        rx_symbol_stream=rx_symbol_stream+[......]
        
        %equalization; compensate for the channel distortion
        equalized_symbol_stream_temp = [........]
